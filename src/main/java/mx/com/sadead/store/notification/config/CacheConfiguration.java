package mx.com.sadead.store.notification.config;
...
public class CacheConfiguration implements DisposableBean {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        config.getMapConfigs().put("mx.com.sadead.store.notification.domain.*", initializeDomainMapConfig(jHipsterProperties));
